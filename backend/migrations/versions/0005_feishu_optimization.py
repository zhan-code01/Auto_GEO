...
def upgrade():
    ...
    op.add_column(
        "geo_articles", sa.Column("fact_risk_score", sa.Integer(), nullable=True, comment="事实风险评估 0-100")
    )
    op.add_column(
        "geo_articles", sa.Column("duplication_score", sa.Integer(), nullable=True, comment="与历史文章重复度 0-100")
    )
    op.add_column(
        "geo_articles", sa.Column("platform_risk_score", sa.Integer(), nullable=True, comment="平台合规风险 0-100")
    )
